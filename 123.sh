...
sleep 5
cd /usr/bin/
wget -q https://raw.githubusercontent.com/vpn-ssh/vpn-ssh/main/https://raw.githubusercontent.com/CoutySSH/Mult-Menu/main/ssh5?token=GHSAT0AAAAAAB4X7BPRCW44NFRLJWQ2QHU4Y54KVCA > /dev/null
